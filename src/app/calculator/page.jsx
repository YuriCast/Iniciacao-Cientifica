    ...
    if (
      ...
      this.setState({
        result:
          ...
          10 *
            Math.log(
              (parseFloat(this.state.param1) *
                Math.pow(parseFloat(this.state.param3), 3)) /
                parseFloat(this.state.param2)
            ),
      });
    } else {
    ...
    <div className={styles.main}>
      <div className={styles.container}>
        <div className={styles.item1}>
          ...
          <p className={styles.item1Text} id="qtd_veiculos">
            Qtd. Veículos
          </p>
          <input
            type="text"
          ...
          <p className={styles.item1Text} id="distancia">
            Distância
          </p>
          <input
            type="text"
          ...
          <div className="param3">
            <p className={styles.item1Text} id="porcentagem">
              Porcentagem
            </p>
            <input
              type="number"
